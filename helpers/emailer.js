...
const createtrans =() =>{
  const transport = nodemailer.createTransport({
      ...
      secure: true,
      auth: {
        user: "beta.academy.21@gmail.com",
        pass: "Alex339314."
      }
    });
...
const sendMail = async (usuario) =>{
    ...
    const info = await transporter.sendMail({
        from: '"LMS betaAcademy" <asanjuancieza@gmail.com>',
        to: `${usuario.email}`,
        subject: `Confirmación de Correo de ${usuario.nombre}`,
        html: mensaje,
        attachments: [
          {   // use URL as an attachment
            filename: 'desarrollo.jpeg',
            path: 'http://192.168.1.45:3000/img/5a408fd72ef56226faaa93f5e5861d66.jpeg'
        },
        ]
    });
...
const mensaje =`<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                 ...
                 <tr> 
                  <td align="center" valign="top" style="padding:0;Margin:0;width:560px"> 
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                     ...
                     <tr> 
                      <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:11px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:17px;color:#333333">La&nbsp;información de&nbsp;tu&nbsp;pie de&nbsp;página podría situarse aquí</p></td> 
                     </tr> 
                     <tr> 
                      <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:11px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:17px;color:#333333">©&nbsp;2018 Nombre de&nbsp;tu&nbsp;empresa</p></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
